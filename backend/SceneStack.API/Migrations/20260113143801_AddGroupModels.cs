        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupMemberHistories_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupMemberHistories_Users_ActorId",
                        column: x => x.ActorId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupMemberHistories_ActorId",
                table: "GroupMemberHistories",
                column: "ActorId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupMemberHistories_GroupId",
                table: "GroupMemberHistories",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupMemberHistories_GroupId_UserId_Timestamp",
                table: "GroupMemberHistories",
                columns: new[] { "GroupId", "UserId", "Timestamp" });
