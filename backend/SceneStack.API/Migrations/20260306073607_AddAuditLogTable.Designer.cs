...
namespace SceneStack.API.Migrations
{
    ...
    [Migration("20260306073607_AddAuditLogTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SceneStack.API.Models.AuditLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SceneStack.API.Models.GroupInvitation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SceneStack.API.Models.Movie", b =>
                {
                    ...
                    b.Property<List<DirectorMember>>("Directors")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.Property<List<WriterMember>>("Writers")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("SceneStack.API.Models.MovieGroup", b =>
                {
                    b.Property<int>("MovieId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SceneStack.API.Models.GroupInvitation", b =>
                {
                    ...
                    b.HasOne("SceneStack.API.Models.User", "InvitedByUser")
                        .WithMany()
                        .HasForeignKey("InvitedByUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("SceneStack.API.Models.User", "InvitedUser")
                        .WithMany()
